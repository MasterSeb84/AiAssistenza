            ...
            once: true
              ...
              <div className="relative mb-8">
                <div className="w-80 h-80 mx-auto lg:mx-0 rounded-full overflow-hidden border-4 border-white/20 shadow-2xl">
                  <img alt="Sebastiano Biscuso - Tecnico Informatico Esperto" className="w-full h-full object-cover" src="https://horizons-cdn.hostinger.com/5f49cba6-7d4e-44da-8cef-ece0ddf104f3/217-sThJu.jpeg" />
                </div>
